...
ROOT_URLCONF = 'discussion_blog.urls'
...
WSGI_APPLICATION = 'discussion_blog.wsgi.application'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'your_example_email@gmail.com'
else:
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
    EMAIL_USE_TLS = True
    EMAIL_PORT = 587
    EMAIL_HOST = 'smtp.gmail.com'
    EMAIL_HOST_USER = os.environ.get('yuse_91yus@hotmail.com')
    EMAIL_HOST_PASSWORD = os.environ.get('xfjf yfdu ajgz tmdo')
    DEFAULT_FROM_EMAIL = os.environ.get('yuse_91yus@hotmail.com')
